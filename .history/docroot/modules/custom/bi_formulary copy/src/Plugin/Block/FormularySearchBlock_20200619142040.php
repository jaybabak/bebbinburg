...
class FormularySearchBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\acme_sports_nfl_teams\BiFormularyApiService
   */
  protected $ftf;
   ...
   * @param \Drupal\acme_sports_nfl_teams\BiFormularyApiService $ftf
  ...
  public function build() {
    ...
    $form = $this->formBuilder->getForm('Drupal\acme_sports_nfl_teams\Form\BiFormularyForm', $parameters);
    // Attach the formulary library.
    $form['#attached']['library'] = ['acme_sports_nfl_teams/formulary'];
    // Return the form.
    return $form;
  }
