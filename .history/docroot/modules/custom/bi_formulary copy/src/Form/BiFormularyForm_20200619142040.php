...
use Drupal\acme_sports_nfl_teams\Event\FormularySubmitEventDtm;
...
class BiFormularyForm extends FormBase implements ContainerInjectionInterface {
  ...
  public function getFormId() {
    return 'acme_sports_nfl_teams_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $parameter = NULL) {
    ...
    $config = $this->configFactory->get('acme_sports_nfl_teams.settings');
  ...
  public function successfulAjaxSubmit(array $form, FormStateInterface $form_state) {
    ...
    $build['formulary_results_container'] = [
      ...
      '#theme' => 'acme_sports_nfl_teams_results',
      '#download_link' => NULL,
      '#error' => NULL,
      '#no_results' => NULL,
      '#cache' => [
